...
<script>
import navcomt from "./navComt";
import { ref } from "vue";
import { login } from "@/assets/js/base";
import { heandleSelect } from "../assets/js/nav";
export default {
  data() {
    return {
      // activeIndex: 1,
      ...
      bill: [
        ...
        [{ name: '送货汇总' }, { name: "客户月账单金额汇总" }, { name: "客户产品订单汇总" }, { name: "产品订单汇总" }, { name: "客户月账单汇总" }]
      ],
      basics: [
